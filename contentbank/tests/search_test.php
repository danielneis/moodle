...
class core_contentbank_search_testcase extends advanced_testcase {
    ...
    public function test_contents_indexing_contexts() {
        ...
        $this->assertEquals([$content2->get_id(), $content3->get_id()], $results);
    ...
    public function test_contents_document() {
        ...
        $this->assertEquals($this->contentsareaid . '-' . $content->get_id(), $doc->get('id'));
         // TODO; $this->assertEquals($course->id, $doc->get('courseid'));
    ...
    public function test_contents_access() {
        ...
        // TODO: $this->assertEquals(\core_search\manager::ACCESS_GRANTED, $searcharea->check_access($publiccontent->get_id()));
        ...
        // TODO: $this->assertEquals(\core_search\manager::ACCESS_GRANTED, $searcharea->check_access($publiccontent->get_id()));
        // TODO: $this->assertEquals(\core_search\manager::ACCESS_GRANTED, $searcharea->check_access($unlistedcontent->get_id()));
