...
$string['changefolder'] = 'Change folder';
...
$string['currentfolder'] = 'Current folder: {$a}';
...
$string['displayunlisted'] = 'Display unlisted';
$string['dontdisplayunlisted'] = 'Dont\'t Display unlisted';
$string['duplicatedfoldername'] = 'Folder name already exists';
...
$string['deletecontentforever'] = 'Delete content forever';
$string['deletecontentforeverconfirm'] = 'Are you sure you want to delete the content <em>\'{$a->name}\'</em> and all associated files? This action cannot be undone.';
...
$string['deletecontentconfirm'] = 'Ate you sure you want to delete the content <em>\'{$a->name}\'</em>? You will be able to restore it from the trash if needed.';
...
$string['privacy:metadata:content:depth'] = 'The depth of the folder.';
$string['privacy:metadata:content:name'] = 'Name of the content in the content bank.';
$string['privacy:metadata:content:parent'] = 'The parent folder of the content or folder (how many folders on path).';
$string['privacy:metadata:content:path'] = 'The path of folders where the folder is located.';
$string['privacy:metadata:content:timecreated'] = 'The time when the content or folder was created.';
$string['privacy:metadata:content:timemodified'] = 'The time when the content or folder was modified.';
$string['privacy:metadata:content:usercreated'] = 'The user has created the content or folder.';
$string['privacy:metadata:content:usermodified'] = 'The last user who modified the content or folder.';
$string['privacy:metadata:contentbankcontent'] = 'Stores the content of the content bank.';
$string['privacy:metadata:contentbankfolder'] = 'Stores the folder of the content bank.';
...
$string['restorecontent'] = 'Restore content';
$string['restorecontentconfirm'] = 'Are you sure you want to restore this content to it\'s original folder?';
$string['searchcontentbankbyname'] = 'Search for content by name';
$string['search:customfield'] = 'Content bank custom fields';
$string['size'] = 'Size';
