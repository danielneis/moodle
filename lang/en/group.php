...
$string['errorremovegroupnotpermitted'] = 'You do not have permission to remove automatically-added group {$a}';
$string['errorremovegroup'] = 'Error removing group {$a}';
...
$string['groupcreatedby'] = '(group created by \'{$a}\' component)';
