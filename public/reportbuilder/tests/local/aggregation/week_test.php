...
/**
 * Unit tests for week aggregation
 *
 * @package     core_reportbuilder
 * @covers      \core_reportbuilder\local\aggregation\week
 * @copyright   2025 Daniel Neis Araujo <danielneis@gmail.com>
 * @copyright   2024 Paul Holden <paulh@moodle.com>
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
final class week_test extends core_reportbuilder_testcase {
    /**
     * Mock the clock
     */
    ...
    public function test_column_aggregation(): void {
        ...
        $this->getDataGenerator()->create_user(['firstname' => 'Gustavo', 'lastaccess' => 1748667960]);
        ...
        $generator->create_column([
            ...
            'aggregation' => week::get_class_name(),
            'sortenabled' => 1,
        ...
        $this->assertEquals([
            ['28 December 1969 - 3 January 1970', 'Admin'],
            ['30 May 2021 - 5 June 2021', 'Andy, Bob, Charlie'],
            ['25 May 2025 - 31 May 2025', 'Gustavo'],
